...
export const gridItems = [
    ...
    },
    {
        ...
        description: "",
        className: "lg:col-span-2 md:col-span-3 row-span-4 md:row-span-2",
        imgClassName: "",
...
export const workExperience = [
    {
        id: 1,
        title: "Frontend Developer, ADVAC",
    ...
    },
    {
        ...
        desc: "Designed and developed web app during intership time using Blazor",
        className: "md:col-span-2",
        thumbnail: "/exp2.svg",
    },
    {
        ...
        desc: "Led the dev of a web app for a client, from initial concept to deployment and publish",
        className: "md:col-span-2",
        thumbnail: "/exp3.svg",
    },
];
...
export const socialMedia = [
    {
        id: 1,
        img: "/git.svg",
        link: 'https://github.com/diaa852000'
    },
    {
        id: 3,
        img: "/link.svg",
        link: 'https://www.linkedin.com/in/diaa-el-taiby-64861416a/'
    },
];